...
const payments = [
  ...
  { id: "p2", date: "2025-09-02", supplier: "XYZ Distributors", amount: 12000 },
  { id: "p1", date: "2025-09-01", supplier: "ABC Traders", amount: 15000 },
  { id: "p2", date: "2025-09-02", supplier: "XYZ Distributors", amount: 12000 },
  { id: "p1", date: "2025-09-01", supplier: "ABC Traders", amount: 15000 },
  { id: "p2", date: "2025-09-02", supplier: "XYZ Distributors", amount: 12000 },
...
export default function PaymentReport() {
  ...
  return (
                      ...
                      <Text className="text-white  text-sm"> {format(toDate, "dd MMM yyyy")}</Text>
                        ...
                        <View className="flex-row justify-between mb-4">
                          <View className="bg-black-200 p-4 rounded-2xl w-[48%]">
                            <Text className="text-zinc-300 text-sm">Total Payment</Text>
    ...
    <View className="flex-1 bg-dark p-2">
      <Text className="text-white text-xl font-bold mb-4">Payment Report</Text>
      <FlatList
        data={payments}
        keyExtractor={(item) => item.id}
        renderItem={({ item }) => (
          <View className="bg-black-200 p-4 rounded-xl mb-3">
            <Text className="text-white font-semibold">{item.supplier}</Text>
